...
DB_USER="postgres"
DB_NAME="grupo4" #Esto se deberá modificar para cada grupo de clase
...
# Realizar el backup
docker exec -e PGPASSWORD=$DB_PASSWORD $CONTAINER_NAME pg_dump -U $DB_USER $DB_NAME > $BAC  KUP_FILE
